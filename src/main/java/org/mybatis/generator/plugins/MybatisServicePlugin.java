 ...
 * fileName: MybatisServicePlugin.java   
 * packageName: org.mybatis.generator.plugins   
 * date: 2018年2月25日下午6:51:23   
...
/**     
 * @title: MybatisServicePlugin.java   
 * @package org.mybatis.generator.plugins   
 * @description: Service插件  
 * @author: fendo  
 * @date: 2018年2月25日 下午6:51:23   
 * @version: V1.0     
*/
public class MybatisServicePlugin extends PluginAdapter {
    ...
    protected void addService(Interface interface1, IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
        ...
        commentGenerator.addJavaFileComment(interface1);

        // 添加类注释
        commentGenerator.addExampleClassComment(interface1,introspectedTable,"的Service");
    ...
    protected void addServiceImpl(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String tableName, List<GeneratedJavaFile> files) {
        ...
        // 添加类注释
        commentGenerator.addExampleClassComment(topLevelClass,introspectedTable,"Service的Impl");
