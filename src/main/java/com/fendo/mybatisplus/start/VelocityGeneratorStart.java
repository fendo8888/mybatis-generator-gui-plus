 ...
 * fileName: VelocityGeneratorStart.java   
 * packageName: com.fendo.mybatisplus.start   
 * date: 2018年3月1日上午9:04:49   
...
/**     
 * @title: VelocityGeneratorStart.java   
 * @package com.fendo.mybatisplus.start   
 * @description: TODO  
 * @author: fendo  
 * @date: 2018年3月1日 上午9:04:49   
 * @version: V1.0     
*/
public class VelocityGeneratorStart {
...
//	                   // 自定义输入文件名称
//	                   return "D:\\codeGen\\my_" + tableInfo.getEntityName() + ".jsp";
//	               }
//	           });
